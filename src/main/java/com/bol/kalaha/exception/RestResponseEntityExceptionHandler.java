...
import com.bol.kalaha.config.ErrorConstants;
import com.bol.kalaha.dto.Error;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   */
    ...
    Error error = new Error();
    error.setErrors(
        List.of(ErrorAttributes.builder().code(errorAttributes.getCode()).message(errorAttributes.getMessage()+ex.getMessage())
